...
import {ArgentAccountV0dot1dot0} from "./ArgentAccount_v0.1.0.sol";

contract AccountFactoryV0dot1dot0 {
    ...
    function proxyContructorData(
        ...
        bytes memory initData = abi.encodeCall(ArgentAccountV0dot1dot0.initialize, (_owner, _guardian));

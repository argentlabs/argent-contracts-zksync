...
export interface DappWhitelistPaymasterInterface extends utils.Interface {
  functions: {
    ...
    "whitelistDapp(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "whitelistDapp",
    values: [PromiseOrValue<string>]
  ): string;
...
export interface DappWhitelistPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DappWhitelistPaymasterInterface;
